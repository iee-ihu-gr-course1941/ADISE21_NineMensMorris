...
function fill_board_by_data(data,x,y) {
	for(var i=0;i<data.length;i++) {
		...
		im.classList.addClass
		if (o.Bcolor == 'r') { 
			im ='<img class="piece" src="images/B.png">'; 
		} else if (o.Bcolor == 'g') {
			im ='<img class="piece" src="images/W.png">';
		}
		if(id.classList.contains('wpawn') || o.classList.contains('bpawn'){
			alert.('there is already a pawn');
		}else {
			if (o.piece_color == 'W' ){
				im = '<img class="piece wpawn" src="images/wpawn.png">'; 
			}else if(o.piece_color == 'B'){
				im = '<img class="piece bpawn" src="images/bpawn.png">';
			}
		}
