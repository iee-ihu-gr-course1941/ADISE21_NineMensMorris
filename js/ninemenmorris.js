...
function login_to_game() {
	...
	$.ajax({url: "NineMenMorris.php/players/"+p_color, 
			...
			data: JSON.stringify( {username: $('#username').val(), color: p_color}),
...
function update_info(){
	$('#game_info').html("I am Player: "+me.color+", my name is "+me.username +'<br>Token='+me.token+'<br>Game state: '+game_status.status+', '+ game_status.p_turn+' must play now.');
