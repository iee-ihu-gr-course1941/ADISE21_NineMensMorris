...
function update_status(data) {
	...
	update_info();
	clearTimeout(timer);
	if(game_status.p_turn==me.piece_color &&  me.piece_color!=null && game_status.status!='ended') {
	...
	if(game_status.status == 'ended' && (game_status.result == 'W' || game_status.result == 'B')){
		$('#win_info').html("Player "+game_status.result+" is the winner!!!!!");
	}
}
...
function do_premove(data) {
	...
	var pnumb = data[0];
//
	if((pnumb.playernumber < 9) && ($(z).children().hasClass('W') || $(z).children().hasClass('B'))){
...
function addmove() {
	...
	var d = document.getElementById('square_'+a[0]+'_'+a[1]);
	if(d.childNodes[0].classList.contains('W') || d.childNodes[0].classList.contains('B')){
...
function One1_14_17(varobj){
	if(square_1_1.childNodes[0].classList.contains('W') && square_1_4.childNodes[0].classList.contains('W')
...
function One1_41_71(varobj){
	if(square_1_1.childNodes[0].classList.contains('W') && square_4_1.childNodes[0].classList.contains('W')
...
function One7_47_77(varobj){
	if(square_1_7.childNodes[0].classList.contains('W') && square_4_7.childNodes[0].classList.contains('W')
...
function seven1_74_77(varobj){
	if(square_7_1.childNodes[0].classList.contains('W') && square_7_4.childNodes[0].classList.contains('W')
		&& square_7_7.childNodes[0].classList.contains('W')) {
...
function two2_42_62(varobj){
	if(square_2_2.childNodes[0].classList.contains('W') && square_4_2.childNodes[0].classList.contains('W')
...
function two2_24_26(varobj){
	if(square_2_2.childNodes[0].classList.contains('W') && square_2_4.childNodes[0].classList.contains('W')
...
function two6_46_66(varobj){
	if(square_2_6.childNodes[0].classList.contains('W') && square_4_6.childNodes[0].classList.contains('W')
...
function six2_64_66(varobj){
	if(square_6_2.childNodes[0].classList.contains('W') && square_6_4.childNodes[0].classList.contains('W')
		&& square_6_6.childNodes[0].classList.contains('W')) {
...
function three3_43_53(varobj){
	if(square_3_3.childNodes[0].classList.contains('W') && square_4_3.childNodes[0].classList.contains('W')
...
function three3_34_35(varobj){
	if(square_3_3.childNodes[0].classList.contains('W') && square_3_4.childNodes[0].classList.contains('W')
...
function five3_54_55(varobj){
	if(square_5_3.childNodes[0].classList.contains('W') && square_5_4.childNodes[0].classList.contains('W')
		&& square_5_5.childNodes[0].classList.contains('W')) {
...
function one4_24_34(varobj){
	if(square_1_4.childNodes[0].classList.contains('W') && square_2_4.childNodes[0].classList.contains('W')
...
function five4_64_74(varobj){
	if(square_5_4.childNodes[0].classList.contains('W') && square_6_4.childNodes[0].classList.contains('W')
...
function four1_42_43(varobj){
	if(square_4_1.childNodes[0].classList.contains('W') && square_4_2.childNodes[0].classList.contains('W')
...
function four5_46_47(varobj){
	if(square_4_5.childNodes[0].classList.contains('W') && square_4_6.childNodes[0].classList.contains('W')
...
function bOne1_14_17(varobj){
	if(square_1_1.childNodes[0].classList.contains('B') && square_1_4.childNodes[0].classList.contains('B')
...
function bOne1_41_71(varobj){
	if(square_1_1.childNodes[0].classList.contains('B') && square_4_1.childNodes[0].classList.contains('B')
...
function bOne7_47_77(varobj){
	if(square_1_7.childNodes[0].classList.contains('B') && square_4_7.childNodes[0].classList.contains('B')
...
function bseven1_74_77(varobj){
	if(square_7_1.childNodes[0].classList.contains('B') && square_7_4.childNodes[0].classList.contains('B')
		&& square_7_7.childNodes[0].classList.contains('B')) {
...
function btwo2_42_62(varobj){
	if(square_2_2.childNodes[0].classList.contains('B') && square_4_2.childNodes[0].classList.contains('B')
...
function btwo2_24_26(varobj){
	if(square_2_2.childNodes[0].classList.contains('B') && square_2_4.childNodes[0].classList.contains('B')
...
function btwo6_46_66(varobj){
	if(square_2_6.childNodes[0].classList.contains('B') && square_4_6.childNodes[0].classList.contains('B')
...
function bsix2_64_66(varobj){
	if(square_6_2.childNodes[0].classList.contains('B') && square_6_4.childNodes[0].classList.contains('B')
		&& square_6_6.childNodes[0].classList.contains('B')) {
...
function bthree3_43_53(varobj){
	if(square_3_3.childNodes[0].classList.contains('B') && square_4_3.childNodes[0].classList.contains('B')
...
function bthree3_34_35(varobj){
	if(square_3_3.childNodes[0].classList.contains('B') && square_3_4.childNodes[0].classList.contains('B')
...
function bfive3_54_55(varobj){
	if(square_5_3.childNodes[0].classList.contains('B') && square_5_4.childNodes[0].classList.contains('B')
		&& square_5_5.childNodes[0].classList.contains('B')) {
...
function bone4_24_34(varobj){
	if(square_1_4.childNodes[0].classList.contains('B') && square_2_4.childNodes[0].classList.contains('B')
...
function bfive4_64_74(varobj){
	if(square_5_4.childNodes[0].classList.contains('B') && square_6_4.childNodes[0].classList.contains('B')
...
function bfour1_42_43(varobj){
	if(square_4_1.childNodes[0].classList.contains('B') && square_4_2.childNodes[0].classList.contains('B')
...
function bfour5_46_47(varobj){
	if(square_4_5.childNodes[0].classList.contains('B') && square_4_6.childNodes[0].classList.contains('B')
...
function removesuccess(data){
	...
	$(id).addClass(data['c']+'_square').html(im);
...
//	}
	...
	$.ajax({url: "ninemenmorris.php/counternumber/"+pcol, 
			method: 'PUT',
			dataType: "json",
			contentType: 'application/json',
			headers: {"X-Token": me.token},
...
function pawn2(){
	...
	if(pcol == 'W'){
		...
		$.ajax({url: "ninemenmorris.php/getcounternumber/"+pcol, 
			method: 'GET',
			dataType: "json",
			contentType: 'application/json',
			headers: {"X-Token": me.token},
